...
本件に関して、 opentofu のメンテナーチームに再検討を願い出たいと考えています。
@04-draft-by-human.md 
に下書きを書きました。

これのレビューと推敲を行い、同一の内容が既に保存されている
@05-reviewed-by-agent.md 
の内容を更新してください。

以下の前提でお願いします:

* 私は英語が拙いので、英語の表現としてあまりにも不自然な点があれば手直しをお願いします。
* 本件に関して、あくまで決定権は opentofu のメンテナーチームにあり、この要望は過剰なものであると考えています。このため、決して押し付けがましくなく、検討を願い出るという形式でお願いします。
* 本リポジトリーでこれまで検討してきたドキュメントも照らし合わせ、考慮が不足している、事実と反している事項などがあったら修正と指摘をお願いします。
